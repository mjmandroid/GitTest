...
public class PhotoUtils {
	...
	public static Map<String, PhotoFolder> getPhotos(Context context) {
		Map<String, PhotoFolder> floderMap = new HashMap<String, PhotoFolder>();

		String allPhotosKey = "所有图片";
		PhotoFolder allFloder = new PhotoFolder();
		...
		while (mCursor.moveToNext()) {
			...
			if (floderMap.containsKey(dirPath)) {
				...
				PhotoFolder photoFloder = floderMap.get(dirPath);
				...
				// 初始化imageFloder
				PhotoFolder photoFloder = new PhotoFolder();
