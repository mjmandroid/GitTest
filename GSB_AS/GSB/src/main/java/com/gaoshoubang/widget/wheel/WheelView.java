...
import com.gaoshoubang.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	 ...
	 */
	private int[] SHADOWS_COLORS = new int[]{0xffffffff, 0xcfE9E9E9, 0x3fE9E9E9};

	private int cententLineColor = 0xff999999;
	...
	// Wheel drawables
	private int wheelBackground = 0x00000000;
	// Shadows drawables
	 ...
	 * @param resource
	 */
	public void setWheelBackground(int color) {
	...
	private void initResourcesIfNecessary() {
		...
		setBackgroundColor(wheelBackground);
	}
	...
	private void drawCenterRect(Canvas canvas) {
		...
		/*
		 * / 使用自己的画线，而不是描边 Rect rect = new Rect(left, top, right, bottom)
		 * centerDrawable.setBounds(bounds) centerDrawable.setBounds(0, center -
		 * offset, getWidth(), center + offset); centerDrawable.draw(canvas); //
		 */
		Paint paint = new Paint();
		paint.setColor(cententLineColor);
		// 设置线宽
