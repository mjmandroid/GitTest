package com.andview.refreshview.progress;
...
public class CircleProgress extends View {
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		int color2 = Color.parseColor("#ff9600");
		int color3 = Color.parseColor("#003cff");
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		int width = getDefaultSize(radius, widthMeasureSpec);
		int height = getDefaultSize(radius, heightMeasureSpec);
