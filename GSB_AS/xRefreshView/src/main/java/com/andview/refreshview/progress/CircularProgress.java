...
public class CircularProgress extends View {
	...
	private float mBorderWidth = 3;// 宽度
	...
	public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		mColors = new int[4];
		mColors[0] = Color.parseColor("#da4415");
		mColors[1] = Color.parseColor("#1c10ba");
		mColors[2] = Color.parseColor("#e78f05");
		mColors[3] = Color.parseColor("#eeb211");
