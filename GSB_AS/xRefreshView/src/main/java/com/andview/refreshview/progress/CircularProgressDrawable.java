...
public class CircularProgressDrawable extends Drawable implements Animatable {
	...
	/**
	 * 绘制圆弧臂长的动画，该动画受 mModeAppearing 控制， 当 mModeAppearing 为 false
	 ...
	 */
	private static final int ANGLE_ANIMATOR_DURATION = 300;
	/**
	 * 圆弧臂长的动画间隔，也就是臂长从最小到最大值的变化时间，也可以把该值扩大10倍来查看动画的慢动作
	 */
	private static final int SWEEP_ANIMATOR_DURATION = 100;
	/**
	 * 圆弧的最下臂长是多少度
	 */
